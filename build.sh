...
cargo install --target x86_64-unknown-linux-gnu --root opt/amd64 --path crates/dtls-proxy
cargo install --target x86_64-unknown-linux-gnu --root opt/amd64 --path crates/swbrd
